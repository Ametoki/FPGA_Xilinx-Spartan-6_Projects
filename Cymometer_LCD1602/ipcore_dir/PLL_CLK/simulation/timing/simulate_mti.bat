...
vlog -work work PLL_CLK_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax PLL_CLK_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.PLL_CLK_tb work.glbl
